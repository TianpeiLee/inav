...
void usbVcpInitHardware(void)
{
    ...
    IOInit(IOGetByTag(IO_TAG(PB6)), OWNER_USB, RESOURCE_INPUT, 0);
    IOInit(IOGetByTag(IO_TAG(PB7)), OWNER_USB, RESOURCE_OUTPUT,0);
...
serialPort_t *usbVcpOpen(void)
{
    ...
    // return &s->port;
     return (serialPort_t *)s; //s->port is the first member
}
