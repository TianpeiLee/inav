...
set(CMSIS_INCLUDE_DIR "${MAIN_LIB_DIR}/main/CH32H41x/DSP/Core/Include")

# DSP use common
set(CMSIS_DSP_DIR "${MAIN_LIB_DIR}/main/CH32H41x/DSP")
...
set(CMSIS_DSP_SRC
    ...
    TransformFunctions/riscv_cfft_init_f32.c
    ...
    CommonTables/riscv_const_structs.c
...
###测试###
#set(CH32_LINKER_DIR_SELF "${MAIN_SRC_DIR}/../../build/src/main/target/AIRBOTH4/CMakeFiles/AIRBOTH4.elf.dir/__/__/drivers") 
##
...
function(get_ch32_flash_size out size)
    # 4: 16, 6: 32, 8: 64, B: 128, C: 256, D: 384, E: 960, F: 768, G: 1024, H: 1536, I: 2048 KiB
...
#  Main function of CH32
function(target_ch32)
    if(NOT riscv-wch-elf STREQUAL TOOLCHAIN)
        return()
    endif()
